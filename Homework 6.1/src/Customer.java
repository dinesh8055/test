 ...
 *
 * @ Version: 
 *     $Id: Customer.java , Version 1.0 10/04/2014 $ 
 * 
 * Revisions: 
 *     $Log Initial Version $ 
 */
...
/**
 * This program simulates a supermarket using interfaces
 *
 * @author      Dinesh Gudi
...
/**
 * The following interface contains the methods to add a bag and count the items in the cart
 */
...
/**
 * The following interface declares the method to get the count of the items in the bag
 * 
 *
 */

interface BagOperations{
    int getCount(String item_name);
}

/**
 * The following interface contains the common method to add items to both the cart and the bag
 */

interface CartAndBagOperations{
    void add(String item_description, int number);
} 

/**
 * The following class, Customer class, contains the main(), takeDecisions() and selectBagCart().
 */
...
class Bag implements BagOperations,CartAndBagOperations{
...
class Cart implements CartOperations,CartAndBagOperations{
